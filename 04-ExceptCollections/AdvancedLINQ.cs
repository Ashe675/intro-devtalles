namespace AdvancedLinq
{
    ...
    class Program
    {
        ...
        new Statistic { CharacterId = 5, Power = 95 }
            ...
            var teamsMethod = characters.GroupBy(x => x.Team);
            WriteLine("Team QUery");
            ...
            {
                WriteLine($"{character.Name} - {character.Alias}: {character.Description}");
            }

            var charactersWithAbilitiesMethod = characters.Join(
                abilities,
                c => c.Id,
                a => a.CharacterId,
            ...
            foreach (var ability in abilitiesByCharacter)
            {
                WriteLine($"{ability.Character}: {ability.Count} habilidades");
            }
